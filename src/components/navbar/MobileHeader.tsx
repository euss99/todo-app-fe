...
export default function MobileHeader({ onOpen }: MobileHeaderProps) {
  return (
    <div className="lg:hidden">
      <div className="bg-white dark:bg-gray-900 fixed top-0 left-0 right-0 z-30 flex items-center justify-between h-16 px-4 border-b border-gray-200 dark:border-gray-700">
